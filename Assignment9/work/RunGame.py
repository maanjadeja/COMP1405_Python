...
def addNewColourAnomaly():

    roomList=Duty.get_rooms()
    print("HERE IS THE LIST OF ROOMS: "+str(roomList))


    # return Duty.add_anomaly("COLOUR ANOMALY", room, []) here room is the name of the room, and [] is the array of items in the room
...
def register_anomalies():
    ...
    # Duty.register_anomaly("COLOUR ANOMALY")
...
def create_anomaly() -> bool:
    ...
    """
    # print("INSIDE CREATE ANOMALY FUNCIOTN")
    addNewColourAnomaly()
